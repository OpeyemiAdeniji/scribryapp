...
const DropDown = ({ options, className, selected, defaultValue, placeholder, search, image }) => {
    ...
    return (
        <>
            ...
            <DropSelect 
                ...
                controlDisplayImage={image ? image : false}
                controlDisplayLabel={true}
                controlDisplayLeft={false} 
                optionDisplayLeft={false}
                optionDisplayImage={false}
