...

                            {
                                !empty ? (
                                    ...
                                    <>
                                        ...
                                        <p className="font-gilroy brand-purple ui-text-center fs-15 mrgb2 mrgt1" style={{lineHeight: '18px'}}>You have no projects yet. Please <br /> create a project.</p>
